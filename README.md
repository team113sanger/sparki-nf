...
Note that *sparki-nf* runs SPARKI through SPARKI's command line interface (CLI); if you wish to use SPARKI as an R package, please check out [this documentation](https://gitlab.internal.sanger.ac.uk/team113_projects/jb62-projects/sparki/-/blob/develop/tutorials/SPARKI_basic_usage.pdf).
